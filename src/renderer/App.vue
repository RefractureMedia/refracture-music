    ...
    <div class="whole">
      <div class="content clear">
        ...
        <div class="wrap">
          ...
          <nav-bar></nav-bar>
          <input v-if="$route.path.split('/')[1] == 'library' || $route.path.split('/')[1] == 'Library'" type="url" name="youtubeURL" class="songInput" placeholder="Search">
          <div v-if="$route.path.split('/')[1] == 'library' || $route.path.split('/')[1] == 'Library'" id="submitLibrarySearch" style="display: none;"></div>
          <svg v-if="$route.path.split('/')[1] == 'library' || $route.path.split('/')[1] == 'Library'" width="18" height="18" viewBox="0 0 28 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="search_icon">
