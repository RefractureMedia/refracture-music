...
let exports = {
  ...
  parseItem(string, respString, searchString) {
  ...
  getPage(ref, cb) {
    cordova.plugin.http.sendRequest(ref, {
        method: 'get',
        headers: {
